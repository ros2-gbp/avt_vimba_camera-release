## avt_vimba_camera (rolling) - 2001.1.0-1

The packages in the `avt_vimba_camera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling --new-track avt_vimba_camera` on `Mon, 13 Dec 2021 17:06:04 -0000`
